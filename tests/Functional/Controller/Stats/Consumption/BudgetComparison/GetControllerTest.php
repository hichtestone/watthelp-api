...
namespace App\Tests\Functional\Controller\Stats\Consumption\BudgetComparison;
 ...
 * @group controller
 * @group stats
 * @group stats-consumption
 * @group stats-consumption-budget-comparison
 */
class GetControllerTest extends FunctionalWebTestCase
{
    ...
    public function testCanGet(array $params, array $expected): void
    {
        ...
        $this->client->request(Request::METHOD_GET, '/stats/consumption/budget-comparison', $params);
