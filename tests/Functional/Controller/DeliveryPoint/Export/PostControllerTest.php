...
namespace App\Tests\Functional\Controller\DeliveryPoint\Export;
...
class PostControllerTest extends FunctionalWebTestCase
{
    ...
    public function testCanPost(array $post, string $expectedContent): void
    {
        ...
        $this->client->request(Request::METHOD_POST, '/delivery-point/export', [], [], [], \json_encode($post));
