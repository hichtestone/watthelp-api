...
class ListControllerTest extends FunctionalWebTestCase
{
     ...
     */
    public function testCanList(string $user, ?int $page, ?int $perPage, ?string $sort, ?string $sortOrder, ?array $filters, ?string $expand, array $expected): void
    {
        ...
        $this->client->request(Request::METHOD_GET, '/delivery-point', $parameters);
