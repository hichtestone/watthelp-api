...
namespace App\Tests\Functional\Controller\Invoice\Anomaly\Export;
...
class PostControllerTest extends FunctionalWebTestCase
{
    ...
    public function testCanPost(array $post, string $expectedContent): void
    {
        ...
        $this->client->request(Request::METHOD_POST, '/invoice/anomaly/export', [], [], [], \json_encode($post));
