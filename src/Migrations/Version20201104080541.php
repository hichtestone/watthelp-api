 ...
 */
final class Version20201104080541 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DELETE FROM permission WHERE code = \'management.anomaly.note.view\'');
        ...
        $this->addSql('INSERT INTO permission (code, description) VALUES(\'management.anomaly.delete\', \'Supprimer une alerte\')');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DELETE FROM permission WHERE code = \'management.anomaly.delete\'');
        ...
        $this->addSql('INSERT INTO permission (code, description) VALUES(\'management.anomaly.note.view\', \'Voir les commentaires\')');
